...
with DAG(
    ...
    batch_details = {
        "pyspark_batch": {
            "main_python_file_uri": f"gs://weather-data-de/script/weather_data_processing.py",
            "python_file_uris": [],
            "jar_file_uris": [],
            "args": []
        },
        ...
        "environment_config": {
            "execution_config": {
                ...
                "network_uri": "projects/durable-cycle-469408-u1/global/networks/default",
                "subnetwork_uri": "projects/durable-cycle-469408-u1/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="durable-cycle-469408-u1",
        region="us-central1",
